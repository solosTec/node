...
int main(int argc, char **argv) 
{
    ...
    ("config,C", boost::program_options::value<std::string>(&config_file)->default_value(node::get_cfg_name("iec")), "specify the configuration file")
    ...
    //	iec node options
    //
    boost::program_options::options_description node_options("iec");
    ...
    if (vm.count("version"))
    {
		return node::print_version_info(std::cout, "iec");
    }
