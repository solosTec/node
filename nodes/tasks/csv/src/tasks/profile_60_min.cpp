...
namespace node
{
	profile_60_min::profile_60_min(cyng::async::base_task* btp
	...
	cyng::continuation profile_60_min::run()
	{	
		switch (state_) {
	...
	void profile_60_min::stop(bool shutdown)
	{
	...
	cyng::continuation profile_60_min::process()
	{	//	unused
		return cyng::continuation::TASK_CONTINUE;
	}

	std::chrono::system_clock::time_point profile_60_min::calculate_trigger_tp()
	{
