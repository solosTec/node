...
int main(int argc, char **argv) 
{
    ...
    ("config,C", boost::program_options::value<std::string>(&config_file)->default_value(node::get_cfg_name("broker-mbus-radio")), "specify the configuration file")
	//	json, XML
    ...
    try
    {
		...
		//
		node::controller ctrl(config_index, pool_size, json_path, "smf:mbus-radio");
