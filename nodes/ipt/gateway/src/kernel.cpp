				...
				, get_proc_parameter_response(frame.at(3)	//	server id  
					...
					, child_list_tree(OBIS_CODE_ROOT_DATA_COLLECTOR, {
						...
						child_list_tree(OBIS_CODE(81, 81, C7, 86, 20, 01), {
							...
							parameter_tree(OBIS_CODE(81, 81, C7, 8A, 83, FF), make_value(obis(0x81, 0x81, 0xC7, 0x86, 0x11, 0xFF))),
							//	Liste von Einträgen z.B. 08 00 01 00 00 FF := Zählerstand Wasser
							child_list_tree(OBIS_CODE(81, 81, C7, 8A, 23, FF), {
								parameter_tree(OBIS_CODE(81, 81, C7, 8A, 23, 01), make_value(obis(0x08, 0x00, 0x01, 0x00, 0x00, 0xFF))),
								parameter_tree(OBIS_CODE(81, 81, C7, 8A, 23, 02), make_value(obis(0x08, 0x00, 0x01, 0x02, 0x00, 0xFF)))
							})
						}),
