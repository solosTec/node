...
#ifndef NODE_IP_MASTER_TASK_QUERY_FIRMWARE_H
#define NODE_IP_MASTER_TASK_QUERY_FIRMWARE_H
...
namespace node
{
	...
	public:
		...
		using msg_5 = std::tuple<cyng::buffer_t, std::uint32_t, cyng::buffer_t, cyng::buffer_t, bool>;

		using signatures_t = std::tuple<msg_0, msg_1, msg_2, msg_3, msg_4, msg_5>;

	public:
		query_firmware(cyng::async::base_task* btp
