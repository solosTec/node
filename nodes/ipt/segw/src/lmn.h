...
namespace node
{
	...
	private:
		 ...
		 */
		cyng::async::task_list_t start_wireless_mbus_receiver(bool profile, cfg_broker::broker_list_t&&);
		cyng::async::task_list_t start_wired_mbus_receiver(bool profile, cfg_broker::broker_list_t&&);
