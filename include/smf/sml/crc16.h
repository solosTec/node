 ...
 *
 */
#ifndef SMF_SML_CRC16_H
#define SMF_SML_CRC16_H
...
namespace smf
{
	namespace sml	
	{
		...
		constexpr std::uint16_t fcstab[256] = { 0x0000, 0x1189, 0x2312, 0x329b, 0x4624, 0x57ad, 0x6536, 0x74bf, 0x8c48,
		 ...
		 */
		constexpr std::uint16_t crc_init() {
			return 0xFFFF;
		}
		 ...
		 */
		constexpr std::uint16_t crc_finalize(std::uint16_t crc) {
			crc ^= 0xffff;
		 ...
		 */
		constexpr std::uint16_t crc_update(std::uint16_t crc, unsigned char c) {
		...
		std::uint16_t crc16_calculate(cyng::buffer_t const&);
