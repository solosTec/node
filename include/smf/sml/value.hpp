    ...
    namespace sml {
        ...
        namespace detail {
            ...
            template <> struct factory_policy<std::uint8_t> {
                template <typename U> static cyng::tuple_t create(U v) {
                    return cyng::make_tuple(static_cast<std::uint8_t>(PROC_PAR_VALUE), static_cast<std::uint8_t>(v));
                }
            };
            template <> struct factory_policy<std::uint16_t> {
                template <typename U> static cyng::tuple_t create(U v) {
                    return cyng::make_tuple(static_cast<std::uint8_t>(PROC_PAR_VALUE), static_cast<std::uint16_t>(v));
                }
            };
            template <> struct factory_policy<std::uint32_t> {
                template <typename U> static cyng::tuple_t create(U v) {
                    return cyng::make_tuple(static_cast<std::uint8_t>(PROC_PAR_VALUE), static_cast<std::uint32_t>(v));
                }
            };
            template <> struct factory_policy<std::uint64_t> {
                template <typename U> static cyng::tuple_t create(U v) {
                    return cyng::make_tuple(static_cast<std::uint8_t>(PROC_PAR_VALUE), static_cast<std::uint64_t>(v));
                }
            };
            template <> struct factory_policy<std::int8_t> {
                template <typename U> static cyng::tuple_t create(U v) {
                    return cyng::make_tuple(static_cast<std::uint8_t>(PROC_PAR_VALUE), static_cast<std::int8_t>(v));
                }
            };
            template <> struct factory_policy<std::int16_t> {
                template <typename U> static cyng::tuple_t create(U v) {
                    return cyng::make_tuple(static_cast<std::uint8_t>(PROC_PAR_VALUE), static_cast<std::int16_t>(v));
                }
            };
            template <> struct factory_policy<std::int32_t> {
                template <typename U> static cyng::tuple_t create(U v) {
                    return cyng::make_tuple(static_cast<std::uint8_t>(PROC_PAR_VALUE), static_cast<std::int32_t>(v));
                }
            };
            template <> struct factory_policy<std::int64_t> {
                template <typename U> static cyng::tuple_t create(U v) {
                    return cyng::make_tuple(static_cast<std::uint8_t>(PROC_PAR_VALUE), static_cast<std::int64_t>(v));
                }
            };
