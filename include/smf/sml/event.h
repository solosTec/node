...
namespace smf
{
	namespace sml
	{
		 ...
		 * @return event type
		 */
		constexpr std::uint32_t evt_get_type(std::uint32_t evt)	{
			return (evt & 0xFF000000) >> 24;
		}
		 ...
		 * @return event level
		 */
		constexpr std::uint32_t evt_get_level(std::uint32_t evt)	{
			return (evt & 0xF00) >> 8;
		}
		 ...
		 * @return event source
		 */
		constexpr std::uint32_t evt_get_source(std::uint32_t evt)	{
			return evt & 0xFF;
		}
