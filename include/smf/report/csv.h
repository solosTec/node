...
namespace smf {
    ...
    namespace csv {
         ...
         */
        // void generate_report_15_minutes(cyng::db::session, report_range const &rr, std::filesystem::path root, std::string
        // prefix);
        ...
        // * Hourly reports
        // */
        // void generate_report_60_minutes(cyng::db::session, report_range const &rr, std::filesystem::path root, std::string
        // prefix);
        ...
        // void
        // generate_report_24_hour_part(cyng::db::session, report_range const &subrr, std::filesystem::path root, std::string
        // prefix);
        ...
        // void collect_report(cyng::db::session, report_range const &subrr, std::filesystem::path root, std::string prefix,
        // srv_id_t);
