...
namespace node
{
	namespace ipt
	{
			...
			, def_key_(def)
		{
			...
			//
			vm.run(cyng::register_function("ipt.set.sk.def", 1, std::bind(&serializer::set_sk, this, std::placeholders::_1)));
			...
			//
			vm.run(cyng::register_function("ipt.push.seq", 0, std::bind(&serializer::push_seq, this, std::placeholders::_1)));

			//
			//	transfer data
			//
			vm.run(cyng::register_function("ipt.transfer.data", 1, std::bind(&serializer::transfer_data, this, std::placeholders::_1)));
