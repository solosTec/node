...
namespace node
{
	namespace sml
	{
		...
		const char* get_unit_name(std::uint8_t u)
		{
			...
			case DEGREE_CELSIUS:				return "celsius";
			case CURRENCY:						return "currency";
			case METER:							return "meter";
			case METRE_PER_SECOND:				return "meter/second";
			case CUBIC_METRE:					return "m3";	//	return "cubicMeter";
			case CUBIC_METRE_CORRECTED:			return "m3Corrected";
			case CUBIC_METRE_PER_HOUR:			return "m3/hour";
			case CUBIC_METRE_PER_HOUR_CORRECTED:return "m3/hourCorrected";
			case CUBIC_METRE_PER_DAY:			return "m3/day";
			case CUBIC_METRE_PER_DAY_CORRECTED:	return "m3/dayCorrected";
			...
			case JOULE_PER_HOUR:				return "joule/hour";
			...
			case KILOGRAM_PER_SECOND:			return "kg/second";
			...
			case ENERGY_PER_VOLUME:				return "energy/Volume";
