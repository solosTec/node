...
namespace node
{
	namespace sml
	{
		...
		static obis_map_t obis_map {
			...
			{ OBIS_FIRMWARE_VERSION, {"FIRMWARE_VERSION", cyng::TC_NULL }},
			...
			{ OBIS_PRODUCTION_DATE, {"PRODUCTION_DATE", cyng::TC_NULL }},
			...
			{ OBIS_MBUS_STATE_1, {"MBUS_STATE_1", cyng::TC_NULL }},
			{ OBIS_MBUS_STATE_2, {"MBUS_STATE_2", cyng::TC_NULL }},
			{ OBIS_MBUS_STATE_3, {"MBUS_STATE_3", cyng::TC_NULL }},
			...
			{ OBIS_CLASS_MBUS_AUTO_ACTIVATE, {"CLASS_MBUS_AUTO_ACTIVATE", cyng::TC_BOOL }},
			...
			{ OBIS_CURRENT_UTC, {"CURRENT_UTC", cyng::TC_TIME_POINT }},
			...
			{ OBIS_DATA_COLLECTOR_REGISTER, {"DATA_COLLECTOR_REGISTER", cyng::TC_NULL }},
			...
			{ OBIS_CUSTOM_IF_IP_ADDRESS_1, {"CUSTOM_IF_IP_ADDRESS_1", cyng::TC_UINT32 } },	//	or octet string
			{ OBIS_CUSTOM_IF_IP_ADDRESS_2, {"CUSTOM_IF_IP_ADDRESS_2", cyng::TC_NULL } },
			{ OBIS_CUSTOM_IF_IP_MASK_1, {"CUSTOM_IF_IP_MASK_1", cyng::TC_NULL } },
			{ OBIS_CUSTOM_IF_IP_MASK_2, {"CUSTOM_IF_IP_MASK_2", cyng::TC_NULL } },
			...
			{ OBIS_CUSTOM_IF_IP_CURRENT_1, {"CUSTOM_IF_IP_CURRENT_1", cyng::TC_UINT32 } },	//	or octet string (IPv4/IPv6)
			{ OBIS_CUSTOM_IF_IP_CURRENT_2, {"CUSTOM_IF_IP_CURRENT_2", cyng::TC_UINT32 } },	//	or octet string (IPv4/IPv6)
			...
			{ OBIS_TARGET_IP_ADDRESS, {"TARGET_IP_ADDRESS", cyng::TC_IP_ADDRESS } },
			{ OBIS_SOURCE_PORT, {"SOURCE_PORT", cyng::TC_UINT16 } },
			{ OBIS_TARGET_PORT, {"TARGET_PORT", cyng::TC_UINT16 } },

			{ OBIS_IPT_ACCOUNT, {"IPT_ACCOUNT", cyng::TC_STRING } },
			{ OBIS_IPT_PASSWORD, {"IPT_PASSWORD", cyng::TC_STRING } },
			...
			{ OBIS_ACCESS_USER_NAME, {"ACCESS_USER_NAME", cyng::TC_STRING } },
			{ OBIS_ACCESS_PASSWORD, {"ACCESS_PASSWORD", cyng::TC_STRING } },
			{ OBIS_ACCESS_PUBLIC_KEY, {"ACCESS_PUBLIC_KEY", cyng::TC_STRING } },
			...
			{ OBIS_IF_1107_METER_ID, {"IF_1107_METER_ID", cyng::TC_STRING } },
			{ OBIS_IF_1107_BAUDRATE, {"IF_1107_BAUDRATE", cyng::TC_NULL } },
			{ OBIS_IF_1107_ADDRESS, {"IF_1107_ADDRESS", cyng::TC_STRING } },
			...
			{ OBIS_NMS_PORT, {"NMS_PORT", cyng::TC_NULL } },
			{ OBIS_NMS_USER, {"NMS_USER", cyng::TC_NULL } },
			{ OBIS_NMS_PWD, {"NMS_PWD", cyng::TC_NULL } },
			{ OBIS_NMS_ENABLED, {"NMS_ENABLED", cyng::TC_NULL } },
