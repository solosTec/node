...
int main(int argc, char** argv) {
	...
	static edis_map_t edis_map {
		...
		{ cyng::edis(0x60, 1, 0), {"REG_SERIAL_NUMBER", "Meter serial number", "" }},
		...
		{ cyng::edis(0, 4, 2), {"REG_CURRENT_TRANSFORMER", "Current transformer", "ratio" }},
		{ cyng::edis(0, 4, 3), {"REG_VOLTAGE_TRANSFORMER", "Voltage transformer", "ratio" }}
	};
