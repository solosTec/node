...
namespace node
{
	namespace sml
	{
		...
		OBIS_CODE_DEFINITION(90, 00, 00, 00, 01, FF, BROKER_ENABLED);
		OBIS_CODE_DEFINITION(90, 00, 00, 00, 02, FF, BROKER_SERVER);
		OBIS_CODE_DEFINITION(90, 00, 00, 00, 03, FF, BROKER_PORT);
		OBIS_CODE_DEFINITION(90, 00, 00, 00, 04, FF, BROKER_BLOCKLIST);
