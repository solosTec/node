...
namespace node
{
	namespace sml
	{
		...
		const static obis	DEFINE_OBIS_CODE(81, 81, C7, 82, 04, FF, CODE_SERVER_ID_VISIBLE);	//	Server ID der sichtbaren Komponenten
		...
		const static obis	DEFINE_OBIS_CODE(01, 00, 00, 09, 0B, 00, READOUT_UTC);	//	readout time in UTC
