...
namespace node
{
	namespace sml
	{
		...
		//	SMF specific codes
		//
		OBIS_CODE_DEFINITION(90, 00, 00, 00, 00, FF, ROOT_BROKER);
		OBIS_CODE_DEFINITION(90, 00, 00, 00, 01, FF, BROKER_LOGIN);
		//OBIS_CODE_DEFINITION(90, 00, 00, 00, 02, FF, BROKER_PORT);	//	example: "/dev/ttyAPP0"

		OBIS_CODE_DEFINITION(90, 00, 00, 00, 03, FF, BROKER_SERVER);
		OBIS_CODE_DEFINITION(90, 00, 00, 00, 04, FF, BROKER_SERVICE);
		OBIS_CODE_DEFINITION(90, 00, 00, 00, 05, FF, BROKER_USER);
		OBIS_CODE_DEFINITION(90, 00, 00, 00, 06, FF, BROKER_PWD);
