...
namespace node
{
	namespace sml
	{
		...
		OBIS_CODE_DEFINITION(81, 02, 17, 07, 01, 02, CUSTOM_IF_IP_MASK_2);	//	[IPv4/IPv6] 
		...
		OBIS_CODE_DEFINITION(81, 02, 17, 07, 00, 00, CUSTOM_IF_IP_CURRENT_1);	//	[IPv4/IPv6] current IP address (customer interface)
		OBIS_CODE_DEFINITION(81, 02, 17, 07, 00, 02, CUSTOM_IF_IP_CURRENT_2);	//	[IPv4/IPv6] current IP address (customer interface)
		...
		OBIS_CODE_DEFINITION(90, 00, 00, 00, 03, FF, BROKER_SERVICE);	//	port (u16)
		...
		OBIS_CODE_DEFINITION(91, 00, 00, 00, 00, FF, ROOT_HARDWARE_PORT);
		OBIS_CODE_DEFINITION(91, 00, 00, 00, 01, FF, HARDWARE_PORT_NAME);	//	example: "/dev/ttyAPP0"
		OBIS_CODE_DEFINITION(91, 00, 00, 00, 02, FF, HARDWARE_PORT_DATABITS);
		OBIS_CODE_DEFINITION(91, 00, 00, 00, 03, FF, HARDWARE_PORT_PARITY);
		OBIS_CODE_DEFINITION(91, 00, 00, 00, 04, FF, HARDWARE_PORT_FLOW_CONTROL);
		OBIS_CODE_DEFINITION(91, 00, 00, 00, 05, FF, HARDWARE_PORT_STOPBITS);
		OBIS_CODE_DEFINITION(91, 00, 00, 00, 06, FF, HARDWARE_PORT_SPEED);
		...
		OBIS_CODE_DEFINITION(93, 00, 00, 00, 00, FF, ROOT_LISTENER);
		OBIS_CODE_DEFINITION(93, 00, 00, 00, 01, FF, LISTENER_LOGIN);
		OBIS_CODE_DEFINITION(93, 00, 00, 00, 02, FF, LISTENER_SERVER);	//	ip address
		OBIS_CODE_DEFINITION(93, 00, 00, 00, 03, FF, LISTENER_SERVICE);	//	port (u16)
		OBIS_CODE_DEFINITION(93, 00, 00, 00, 04, FF, LISTENER_USER);
		OBIS_CODE_DEFINITION(93, 00, 00, 00, 05, FF, LISTENER_PWD);
