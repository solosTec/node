    ...
    namespace nms {
        ...
        class reader {
          ...
          private:
            ...
            void cmd_merge_broker(cyng::param_map_t &pm, std::string const &port, lmn_type, cyng::vector_t &&);
            void cmd_merge_blocklist(cyng::param_map_t &pm, lmn_type, cyng::param_map_t &&params);
            void cmd_merge_listener(cyng::param_map_t &pm, std::string const &port, lmn_type, cyng::param_map_t &&params);
