...
namespace smf {
    namespace config {
        std::string get_name(protocol p) {
            ...
            case protocol::IPT: return "IP-TDIN-E43863-4";
            case protocol::IEC: return "IEC-62056";
            case protocol::WIRED_MBUS: return "M-Bus";
            case protocol::WIRELESS_MBUS: return "wM-Bus-EN13757-4";
            case protocol::HDLC: return "HDLC";
            case protocol::SML:
                ...
                return "SMLv1.04";
            case protocol::DLMS: return "DLMS";
            case protocol::COSEM: return "COSEM";
            case protocol::HAYESAT: return "HAYESAT";
            default: break;
            }
