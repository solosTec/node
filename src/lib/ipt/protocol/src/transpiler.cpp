...
namespace smf {
    namespace ipt {
        ...
        std::string app_res_software_version(cyng::buffer_t &&data) { return cyng::to_string_nil(data, 0); }
        std::string app_res_device_identifier(cyng::buffer_t &&data) { return cyng::to_string_nil(data, 0); }
        ...
        std::string tp_req_open_connection(cyng::buffer_t &&data) { return cyng::to_string_nil(data, 0); }

        response_t tp_res_open_connection(cyng::buffer_t &&data) { return cyng::to_numeric_be<response_t>(data, 0); }
