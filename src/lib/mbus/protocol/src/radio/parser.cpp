    ...
    namespace mbus {
        namespace radio {
            ...
            void parser::put(char c) {
                ...
                case state::TPL_SHORT: state_ = state_tpl(c); break;
                case state::TPL_LONG: state_ = state_tpl(c); break;
            ...
            parser::state parser::state_header(char c) {
                ...
                if (pos_ == header::size()) {
                    ...
                    case tplayer_type::LONG: return state::TPL_LONG;
                    default: break;
                    }
                    return state::DATA;
                }
