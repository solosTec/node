...
namespace smf {
    namespace mbus {
        ...
        std::tuple<std::int8_t, unit, cyng::obis> vif::get_vib_type(std::uint8_t medium, dif const &d) const {
            ...
            if ((value_ & 0x78) == 0x00) {
                ...
                if (medium == 5) {
                    ...
                    return {(value_ & 0x07) - 3, unit::WATT_HOUR, cyng::make_obis(medium, 0, 1, 0, 0, 255)};
                }
                //  Active energy import (+A), current value
                return {(value_ & 0x07) - 3, unit::WATT_HOUR, cyng::make_obis(medium, 0, 1, 8, 0, 255)};
            } else if ((value_ & 0x78) == 0x8) {
                //	0x78 = 0b0111 1000
                //	0x08 = 0b0000 1000
                //	->E000 1nnn
                return {(value_ & 0x07), unit::JOULE, cyng::make_obis(medium, 0, 1, 0, 0, 255)};
                ...
                return {static_cast<std::int8_t>(value_ & 0x07) - 6, unit::CUBIC_METRE, cyng::make_obis(medium, 0, 3, 1, 0, 255)};
            } else if ((value_ & 0x78) == 0x18) {
                //	b0001 1000 = 0x18
                //	->E001 1nnn (mass)
                return {static_cast<std::int8_t>((value_ & 0x07) - 3), unit::KILOGRAM, cyng::make_obis(medium, 0, 0, 0, 0, 255)};
            } else if (value_ == 0x22) {
            ...
            //
                ...
                //	b0010 1000 = 0x28
                //	->E010 1nnn (Power)
                return {static_cast<std::int8_t>((value_ & 0x07) - 3), unit::WATT, cyng::make_obis(medium, 0, 8, 0, 0, 255)};
            } else if ((value_ & 0x78) == 0x30) {
                //	b0011 0000 = 0x30
                //	->E011 0nnn (Power)
                return {static_cast<std::int8_t>((value_ & 0x07)), unit::JOULE_PER_HOUR, cyng::make_obis(medium, 0, 8, 0, 0, 255)};
            } else if ((value_ & 0x78) == 0x38) {
                //	b0011 1000 = 0x38
                //	->E011 1nnn (Volume Flow)
                return {
                    static_cast<std::int8_t>((value_ & 0x07) - 6),
                ...
                return {
                    static_cast<std::int8_t>((value_ & 0x07) - 7),
                ...
                return {
                    static_cast<std::int8_t>((value_ & 0x07) - 9),
                ...
                //	->E101 0nnn (Mass flow)
                return {
                    static_cast<std::int8_t>((value_ & 0x07) - 3),
            ...
            //
                ...
                return {
                    static_cast<std::int8_t>((value_ & 0x03) - 3), unit::DEGREE_CELSIUS, cyng::make_obis(medium, 0, 0, 0, 0, 255)};
                ...
                return {static_cast<std::int8_t>((value_ & 0x03) - 3), unit::KELVIN, cyng::make_obis(medium, 0, 0, 0, 0, 255)};
                ...
                //	b0110 1000 = 0x68
                //	 E110 10nn (Pressure)
                return {static_cast<std::int8_t>((value_ & 0x03) - 3), unit::BAR, cyng::make_obis(medium, 0, 0, 0, 0, 255)};
            ...
            //
                ...
                return {0, decode_time_unit(value_ & 0x03), cyng::make_obis(medium, 0, 0, 0, 0, 255)};
                ...
                return {0, decode_time_unit(value_ & 0x03), cyng::make_obis(1, 0, 0, 8, 1, 255)};
            } else if (value_ == 0x78) {
        ...
        std::tuple<std::int8_t, unit, cyng::obis> vif::get_vib_type(std::uint8_t medium, dif const &d, dife const &de) const {
            return {0, unit::UNDEFINED_, cyng::make_obis(medium, 0, 0, 0, de.get_tariff(), de.get_storage_nr())};
        }

        vife::vife(char c)
            : value_(static_cast<std::uint8_t>(c)) {}

        vife::vife(std::uint8_t c)
            : value_(c) {}
