...
namespace smf {
    namespace modem {
            ...
            //vm.register_function("stream.flush", 0, [this, &s](cyng::context &ctx) 
        {
            ...
            //    "print.no-dialtone", 0, std::bind(&serializer::print_msg, this, std::placeholders::_1, "NO DIALTONE"));
            //vm.register_function(
            //    "print.no-carrier", 0, std::bind(&serializer::print_msg, this, std::placeholders::_1, "NO CARRIER"));
            ...
            //vm.register_function(
            //    "req.login.scrambled", 3, std::bind(&serializer::req_login_scrambled, this, std::placeholders::_1));
            //vm.register_function("res.login.public", 2, std::bind(&serializer::res_login_public, this, std::placeholders::_1));
            //vm.register_function(
            //    "res.login.scrambled", 3, std::bind(&serializer::res_login_scrambled, this, std::placeholders::_1));

            //vm.register_function(
            //    "req.open.push.channel", 1, std::bind(&serializer::req_open_push_channel, this, std::placeholders::_1));
            //vm.register_function(
            //    "res.open.push.channel", 8, std::bind(&serializer::res_open_push_channel, this, std::placeholders::_1));

            //vm.register_function(
            //    "req.close.push.channel", 1, std::bind(&serializer::req_close_push_channel, this, std::placeholders::_1));
            //vm.register_function(
            //    "res.close.push.channel", 3, std::bind(&serializer::res_close_push_channel, this, std::placeholders::_1));

            //vm.register_function(
            //    "req.transfer.push.data", 5, std::bind(&serializer::req_transfer_push_data, this, std::placeholders::_1));
            //vm.register_function(
            //    "res.transfer.push.data", 6, std::bind(&serializer::res_transfer_push_data, this, std::placeholders::_1));

            //vm.register_function(
            //    "req.open.connection", 1, std::bind(&serializer::req_open_connection, this, std::placeholders::_1));
            //vm.register_function(
            //    "res.open.connection", 2, std::bind(&serializer::res_open_connection, this, std::placeholders::_1));

            //vm.register_function(
            //    "req.close.connection", 0, std::bind(&serializer::req_close_connection, this, std::placeholders::_1));
            //vm.register_function(
            //    "res.close.connection", 2, std::bind(&serializer::res_close_connection, this, std::placeholders::_1));

            //vm.register_function(
            //    "req.protocol.version", 0, std::bind(&serializer::req_protocol_version, this, std::placeholders::_1));
            //vm.register_function(
            //    "res.protocol.version", 2, std::bind(&serializer::res_protocol_version, this, std::placeholders::_1));

            //vm.register_function(
            //    "req.software.version", 0, std::bind(&serializer::req_software_version, this, std::placeholders::_1));
            //vm.register_function(
            //    "res.software.version", 2, std::bind(&serializer::res_software_version, this, std::placeholders::_1));
            ...
            //vm.register_function(
            //    "req.push.target.namelist", 1, std::bind(&serializer::req_push_target_namelist, this, std::placeholders::_1));
            //vm.register_function(
            //    "res.push.target.namelist", 1, std::bind(&serializer::res_push_target_namelist, this, std::placeholders::_1));

            //vm.register_function(
            //    "req.push.target.echo", 1, std::bind(&serializer::req_push_target_echo, this, std::placeholders::_1));
            //vm.register_function(
            //    "res.push.target.echo", 1, std::bind(&serializer::res_push_target_echo, this, std::placeholders::_1));
            ...
            //vm.register_function(
            //    "req.register.push.target", 3, std::bind(&serializer::req_register_push_target, this, std::placeholders::_1));
            //vm.register_function(
            //    "res.register.push.target", 3, std::bind(&serializer::res_register_push_target, this, std::placeholders::_1));

            //vm.register_function(
            //    "req.deregister.push.target", 1, std::bind(&serializer::req_deregister_push_target, this, std::placeholders::_1));
            //vm.register_function(
            //    "res.deregister.push.target", 3, std::bind(&serializer::res_deregister_push_target, this, std::placeholders::_1));
            ...
            //vm.register_function(
            //    "req.multi.ctrl.public.login", 1, std::bind(&serializer::req_multi_ctrl_public_login, this, std::placeholders::_1));
            //vm.register_function(
            //    "res.multi.ctrl.public.login", 1, std::bind(&serializer::req_multi_ctrl_public_login, this, std::placeholders::_1));
            ...
            //vm.register_function(
            //    "res.unknown.command", 1, std::bind(&serializer::res_unknown_command, this, std::placeholders::_1));
        }
        ...
        //
        //#ifdef _DEBUG
        //            ctx.queue(cyng::generate_invoke("log.msg.info", data.size(), "modem bytes transferred"));
        //#endif
        //        }
        //
        ...
        //        }
        //
        //        void serializer::res_login_public(cyng::context &ctx) { const cyng::vector_t frame = ctx.get_frame(); }
        //
        //        void serializer::res_login_scrambled(cyng::context &ctx) { const cyng::vector_t frame = ctx.get_frame(); }
        //
        //        void serializer::req_watchdog(cyng::context &ctx) { const cyng::vector_t frame = ctx.get_frame(); }
        //
        //        void serializer::res_watchdog(cyng::context &ctx) { const cyng::vector_t frame = ctx.get_frame(); }
        //
        //        void serializer::req_open_push_channel(cyng::context &ctx) {}
        //
        //        void serializer::res_open_push_channel(cyng::context &ctx) { const cyng::vector_t frame = ctx.get_frame(); }
        //
        ...
        //        }
        //
        //        void serializer::req_push_target_echo(cyng::context &ctx) { BOOST_ASSERT_MSG(false, "push target echo is
        //        deprecated"); }
        //
        //        void serializer::res_push_target_echo(cyng::context &ctx) { BOOST_ASSERT_MSG(false, "push target echo is
        //        deprecated"); }
        //
        ...
        //        }
        //
        //        void serializer::res_traceroute(cyng::context &ctx) { BOOST_ASSERT_MSG(false, "traceroute is deprecated"); }
        //
        //        void serializer::req_maintenance(cyng::context &ctx) { BOOST_ASSERT_MSG(false, "maintenance is deprecated"); }
        //
        //        void serializer::res_maintenance(cyng::context &ctx) { BOOST_ASSERT_MSG(false, "maintenance is deprecated"); }
        //
        //        void serializer::req_logout(cyng::context &ctx) { BOOST_ASSERT_MSG(false, "logout is deprecated"); }
        //
        //        void serializer::res_logout(cyng::context &ctx) { BOOST_ASSERT_MSG(false, "logout is deprecated"); }
        //
        ...
        //        }
        //
        //        void serializer::write(cyng::buffer_t const &data) { put(data.data(), data.size()); }
        //        void serializer::put(const char *p, std::size_t size) {
        //            std::for_each(p, p + size, [this](char c) { put(c); });
        //        }
        //
        //        void serializer::put(char c) { ostream_.put(c); }
    } // namespace modem
} // namespace smf
