...
# iec_62056
configure_file (
    "${PROJECT_SOURCE_DIR}/nodes/iec-62056/templates/iec_62056.windows.cgf.in"
    "${PROJECT_BINARY_DIR}/config/iec_62056_v${${PROJECT_NAME}_VERSION_MAJOR}.${${PROJECT_NAME}_VERSION_MINOR}.cfg")

configure_file (
    "${PROJECT_SOURCE_DIR}/nodes/iec-62056/templates/iec_62056_create_service.cmd.in"
    "${PROJECT_BINARY_DIR}/config/iec_62056_create_service.cmd")

configure_file (
    "${PROJECT_SOURCE_DIR}/nodes/iec-62056/templates/iec_62056_delete_service.cmd.in"
    "${PROJECT_BINARY_DIR}/config/iec_62056_delete_service.cmd")

configure_file (
    "${PROJECT_SOURCE_DIR}/nodes/iec-62056/templates/iec_62056_restart_service.cmd.in"
    "${PROJECT_BINARY_DIR}/config/iec_62056_restart_service.cmd")

configure_file (
	"${PROJECT_SOURCE_DIR}/nodes/iec-62056/templates/iec_62056.rc.in"
